...
// ---------------------------------------------------------------------------
// Common units and categories for datalist suggestions
// ---------------------------------------------------------------------------

const UNITS      = ['pcs', 'litres', 'ml', 'kg', 'g', 'metres', 'set', 'pair'];
const CATEGORIES = [
  'Filters', 'Brakes', 'Engine', 'AC Parts', 'Electrical', 'Suspension',
  'Transmission', 'Exhaust', 'Tyres', 'Body Parts', 'Lubricants', 'Consumables',
];
...
export function InventoryForm({ open, onClose, title, defaultValues, onSubmit, isPending, error }: Props) {
  const {
    register,
    handleSubmit,
    reset,
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                <Field label="Part name" required error={errors.name?.message}>
                  <input {...register('name')} placeholder="e.g. Oil Filter" className={inputCls(errors.name?.message)} />
                </Field>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <Field label="Quantity" error={errors.quantity?.message}>
                  <input type="number" step="0.01" min="0" {...register('quantity')} className={inputCls()} />
                </Field>
